...
Reports of unacceptable behavior can be sent to the maintainers (see
[`SECURITY.md`](SECURITY.md) for the contact route). All complaints will
be reviewed and investigated promptly and fairly.

The full Contributor Covenant text, including enforcement guidelines, is
